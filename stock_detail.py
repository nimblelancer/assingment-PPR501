    ...
    if st.session_state.update_data_stock:
        try:
            ...
            with col3:
                ...
                st.markdown(constants.CURRENT_PRICE.format(symbol))
            ...
            # Section 3: 
            tab1, tab2 = st.tabs([constants.ORDER_BOOK_TAB, constants.RAW_DATA_TAB])

            with tab1:
                st.subheader(constants.ORDER_BOOK_TITLE)
                ...
                if not order_book_df.empty:
                    ...
                    st.warning(constants.NO_ORDER_DATA_WARNING)
            with tab2:
